...
qmckl_exit_code qmckl_provide_ee_distance_device(qmckl_context context, int device_id)
{
  ...
  printf("[qmckl_provide_ee_distance_device] In\n");
  if (qmckl_context_check(context) == QMCKL_NULL_CONTEXT) {
    return QMCKL_NULL_CONTEXT;
  }
  ...
  if (ctx->electron.walker.point.date > ctx->electron.ee_distance_date) {
    ...
    printf("[qmckl_provide_ee_distance_device] 1\n");
    ...
    if (ctx->electron.ee_distance == NULL) {
      ...
      printf("[qmckl_provide_ee_distance_device] 2\n");
      if (ee_distance == NULL) {
        return qmckl_failwith( context,
                               QMCKL_ALLOCATION_FAILED,
                               "qmckl_ee_distance",
    ...
    printf("[qmckl_provide_ee_distance_device] 3\n");
    ...
    qmckl_exit_code rc =
      qmckl_compute_ee_distance_device(context,
                                ...
                                device_id);
    printf("[qmckl_provide_ee_distance_device] 4\n");
    if (rc != QMCKL_SUCCESS) {
      return rc;
    }
  ...
  printf("[qmckl_provide_ee_distance_device] Out\n");
  return QMCKL_SUCCESS;
}
#endif
    #+end_src
