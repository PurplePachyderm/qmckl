...
qmckl_exit_code qmckl_set_electron_rescale_factor_en (qmckl_context context, const double kappa_en);
   ...
   #+begin_src c :comments org :tangle (eval h_func)
#ifdef HAVE_DEVICE_POINTERS
qmckl_exit_code qmckl_set_electron_coord_device    (qmckl_context context, const char transp, const double* coord, const int64_t size_max);
#endif
   #+end_src
                         ...
                         const int64_t size_max)
{
  ...
  printf("qmckl_set_electron_coord_device\n");
  ...
  printf("Existing pointers:\n");
  printf("ctx->point.coord=%p\n", ctx->point.coord);
  printf("ctx->electron.coord_old=%p\n", ctx->electron.coord_old);
  printf("ctx->electron.coord_new=%p\n", ctx->electron.coord_new);
  ...
  qmckl_exit_code rc;
  rc = qmckl_set_point_device(context, transp, coord, size_max/3);
  assert (rc == QMCKL_SUCCESS);
...
rc = qmckl_set_electron_coord_device (context, 'N', elec_coord, walk_num*elec_num*3);
assert(rc == QMCKL_SUCCESS);
