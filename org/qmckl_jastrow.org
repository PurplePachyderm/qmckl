...
qmckl_exit_code qmckl_provide_een_rescaled_e_device(qmckl_context context, int device_id)
{
  ...
  printf("[qmckl_provide_een_rescaled_e_device] In\n");
  ...
  if(rc != QMCKL_SUCCESS) return rc;
  printf("[qmckl_provide_een_rescaled_e_device] 1\n");
  ...
  if (ctx->date > ctx->jastrow.een_rescaled_e_date) {
    ...
    printf("[qmckl_provide_een_rescaled_e_device] 2\n");
    ...
    rc = qmckl_compute_een_rescaled_e_device(context,
                                      ...
                                      device_id);
    printf("[qmckl_provide_een_rescaled_e_device] 3\n");
    if (rc != QMCKL_SUCCESS) {
      return rc;
    }
  ...
  printf("[qmckl_provide_een_rescaled_e_device] Out\n");
  return QMCKL_SUCCESS;
}
#endif
    #+end_src
...
qmckl_exit_code qmckl_compute_een_rescaled_e_device (
  ...
  printf("[qmckl_compute_een_rescaled_e_device] In\n");
...
qmckl_exit_code qmckl_provide_een_rescaled_e_deriv_e_device(qmckl_context context, int device_id)
{
  ...
  printf("[qmckl_provide_een_rescaled_e_deriv_e_device] In\n");
  ...
  /* Check if ee distance is provided */
  printf("[qmckl_provide_een_rescaled_e_deriv_e_device] Need ee distance ?\n");
  qmckl_exit_code rc = qmckl_provide_een_rescaled_e_device(context, device_id);
  if(rc != QMCKL_SUCCESS) return rc;

  printf("[qmckl_provide_een_rescaled_e_deriv_e_device] 1\n");
  /* Compute if necessary */
  if (ctx->date > ctx->jastrow.een_rescaled_e_deriv_e_date) {
    ...
    printf("[qmckl_provide_een_rescaled_e_deriv_e_device] About to compute\n");
    rc = qmckl_compute_factor_een_rescaled_e_deriv_e_device(context,
                                                     ...
                                                     device_id);
    printf("[qmckl_provide_een_rescaled_e_deriv_e_device] Done computing\n");
    if (rc != QMCKL_SUCCESS) {
      return rc;
    }
...
qmckl_exit_code qmckl_compute_factor_een_rescaled_e_deriv_e_device (
  ...
  printf("[qmckl_compute_factor_een_rescaled_e_deriv_e_device] In\n");
  ...
  printf("[qmckl_compute_factor_een_rescaled_e_deriv_e_device] Out\n");
  return QMCKL_SUCCESS;
...
qmckl_exit_code qmckl_provide_een_rescaled_n_device(qmckl_context context, int device_id)
{
  ...
  printf("[qmckl_provide_een_rescaled_n_device] In\n");
  ...
  if (ctx->date > ctx->jastrow.een_rescaled_n_date) {
    ...
    printf("[qmckl_provide_een_rescaled_n_device] About to compute\n");
    rc = qmckl_compute_een_rescaled_n_device(context,
                                      ...
                                      device_id);
    printf("[qmckl_provide_een_rescaled_n_device] Done computing\n");
    if (rc != QMCKL_SUCCESS) {
      return rc;
    }
  ...
  printf("[qmckl_provide_een_rescaled_n_device] Out\n");
...
qmckl_exit_code qmckl_compute_een_rescaled_n_device (
  ...
  printf("[qmckl_compute_een_rescaled_n_device] In\n");
  ...
  printf("[qmckl_compute_een_rescaled_n_device] Out\n");
          ...
          int device_id )
{
  ...
  printf("[qmckl_compute_factor_een_rescaled_n_deriv_e_device] In\n");
  ...
  #pragma omp parallel for
  for(int l=0; l<(cord_num+1); l++) {
    for(int a=0; nucl_num; a++) {
      for(int i=0; elec_num; i++) {

        double kappa_l = - ((double) l) * rescale_factor_kappa_en;

        // WIP Fortran to C
/*
        een_rescaled_n_deriv_e(i, 0, a, l, nw) = kappa_l * elnuc_dist_deriv_e(0, i, a);
        een_rescaled_n_deriv_e(i, 1, a, l, nw) = kappa_l * elnuc_dist_deriv_e(1, i, a);
        een_rescaled_n_deriv_e(i, 2, a, l, nw) = kappa_l * elnuc_dist_deriv_e(2, i, a);
        een_rescaled_n_deriv_e(i, 3, a, l, nw) = kappa_l * elnuc_dist_deriv_e(3, i, a);

        een_rescaled_n_deriv_e(i, 3, a, l, nw) = een_rescaled_n_deriv_e(i, 3, a, l, nw) + een_rescaled_n_deriv_e(i, 0, a, l, nw) * een_rescaled_n_deriv_e(i, 0, a, l, nw) + een_rescaled_n_deriv_e(i, 1, a, l, nw) * een_rescaled_n_deriv_e(i, 1, a, l, nw) + een_rescaled_n_deriv_e(i, 2, a, l, nw) * een_rescaled_n_deriv_e(i, 2, a, l, nw);

        een_rescaled_n_deriv_e(i, 0, a, l, nw) = een_rescaled_n_deriv_e(i, 0, a, l, nw) * een_rescaled_n(i, a, l, nw);
        een_rescaled_n_deriv_e(i, 1, a, l, nw) = een_rescaled_n_deriv_e(i, 1, a, l, nw) * een_rescaled_n(i, a, l, nw);
        een_rescaled_n_deriv_e(i, 2, a, l, nw) = een_rescaled_n_deriv_e(i, 2, a, l, nw) * een_rescaled_n(i, a, l, nw);
        een_rescaled_n_deriv_e(i, 3, a, l, nw) = een_rescaled_n_deriv_e(i, 3, a, l, nw) * een_rescaled_n(i, a, l, nw);
*/
      }
    }
  }
  printf("[qmckl_compute_factor_een_rescaled_n_deriv_e_device] 4\n");
  ...
  printf("[qmckl_compute_factor_een_rescaled_n_deriv_e_device] Out\n");
  return rc;
}
#endif
    #+end_src
...
qmckl_exit_code qmckl_get_jastrow_cord_vect_full_device(qmckl_context context, double* const cord_vect_full, int device_id)
{
  ...
  rc = qmckl_provide_dim_cord_vect_device(context, device_id);
  if (rc != QMCKL_SUCCESS) return rc;
...
**** Device pointers version
    ...
    #+begin_src c :comments org :tangle (eval h_private_func) :noweb yes :exports none
qmckl_exit_code qmckl_provide_dim_cord_vect_device(qmckl_context context, int device_id);
...
qmckl_exit_code qmckl_provide_dim_cord_vect_device(qmckl_context context, int device_id)
{
  ...
  if (ctx->date > ctx->jastrow.dim_cord_vect_date) {
    ...
    qmckl_exit_code rc =
    qmckl_compute_dim_cord_vect_device(context,
                                       ctx->jastrow.cord_num,
                                       &(ctx->jastrow.dim_cord_vect),
                                       device_id
    );
...
qmckl_exit_code qmckl_provide_cord_vect_full_device(qmckl_context context, int device_id)
{
  ...
  /* Check if dim_cord_vect is provided */
  qmckl_exit_code rc = qmckl_provide_dim_cord_vect_device(context, device_id);
  if(rc != QMCKL_SUCCESS) return rc;
...
**** Device pointers version
    ...
    #+begin_src c :comments org :tangle (eval h_private_func) :noweb yes :exports none
#ifdef HAVE_DEVICE_POINTERS
    qmckl_exit_code qmckl_compute_dim_cord_vect_device (
          const qmckl_context context,
          const int64_t cord_num,
          int64_t* const dim_cord_vect,
          int device_id
...
qmckl_exit_code qmckl_compute_dim_cord_vect_device (
  ...
  #pragma omp target is_device_ptr(dim_cord_vect)
  {
  *dim_cord_vect = 0;
...
)
{
  ...
  printf("[qmckl_get_jastrow_factor_een_deriv_e_device] In\n");
  ...
  // memcpy(factor_een_deriv_e, ctx->jastrow.factor_een_deriv_e, sze*sizeof(double));
  printf("[qmckl_get_jastrow_factor_een_deriv_e_device] About to memcpy\n");
  ...
  printf("[qmckl_get_jastrow_factor_een_deriv_e_device] Out\n");
...
qmckl_exit_code qmckl_provide_factor_een_deriv_e_device(qmckl_context context, int device_id)
{
  printf("[qmckl_provide_factor_een_deriv_e_device] In\n");
  qmckl_exit_code rc;
  ...
  printf("[qmckl_provide_factor_een_deriv_e_device] About to check provides\n");
  /* Check if en rescaled distance is provided */
  rc = qmckl_provide_een_rescaled_e_device(context, device_id);
  if(rc != QMCKL_SUCCESS) return rc;
  printf("[qmckl_provide_factor_een_deriv_e_device] 1\n");

  /* Check if en rescaled distance derivatives is provided */
  rc = qmckl_provide_een_rescaled_n_device(context, device_id);
  if(rc != QMCKL_SUCCESS) return rc;
  printf("[qmckl_provide_factor_een_deriv_e_device] 2\n");

  /* Check if en rescaled distance is provided */
  rc = qmckl_provide_een_rescaled_e_deriv_e_device(context, device_id);
  if(rc != QMCKL_SUCCESS) return rc;
  printf("[qmckl_provide_factor_een_deriv_e_device] 3\n");

  /* Check if en rescaled distance derivatives is provided */
  rc = qmckl_provide_een_rescaled_n_deriv_e_device(context, device_id);
  if(rc != QMCKL_SUCCESS) return rc;
  printf("[qmckl_provide_factor_een_deriv_e_device] 4\n");

  /* Check if en rescaled distance derivatives is provided */
  rc = qmckl_provide_cord_vect_full_device(context, device_id);
  if(rc != QMCKL_SUCCESS) return rc;
  printf("[qmckl_provide_factor_een_deriv_e_device] 5\n");

  /* Check if en rescaled distance derivatives is provided */
  rc = qmckl_provide_lkpm_combined_index_device(context, device_id);
  if(rc != QMCKL_SUCCESS) return rc;
  printf("[qmckl_provide_factor_een_deriv_e_device] 6\n");

  /* Check if tmp_c is provided */
  rc = qmckl_provide_tmp_c_device(context, device_id);
  if(rc != QMCKL_SUCCESS) return rc;
  printf("[qmckl_provide_factor_een_deriv_e_device] 7\n");

  /* Check if dtmp_c is provided */
  rc = qmckl_provide_dtmp_c_device(context, device_id);
  if(rc != QMCKL_SUCCESS) return rc;
  printf("[qmckl_provide_factor_een_deriv_e_device] 8\n");

  /* Compute if necessary */
  if (ctx->date > ctx->jastrow.factor_een_deriv_e_date) {

    if (ctx->electron.walker.num > ctx->electron.walker_old.num) {
      omp_target_free(ctx->jastrow.factor_een_deriv_e, device_id);
  ...
  printf("[qmckl_provide_factor_een_deriv_e_device] Out\n");
  return QMCKL_SUCCESS;
}
#endif
    #+end_src
