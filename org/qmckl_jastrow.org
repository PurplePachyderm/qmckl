                          ...
                          const int64_t cord_num)
{
  ...
  printf("[qmckl_set_jastrow_ord_num] In\n");
...
<<pre2>>
  ...
  <<post2>>
  printf("[qmckl_set_jastrow_ord_num] Out\n");
}
...
qmckl_set_jastrow_type_nucl_num(qmckl_context context, const int64_t type_nucl_num)
{
  ...
  printf("[qmckl_set_jastrow_type_nucl_num] In\n");
  int32_t mask = 1 << 1;
...
<<pre2>>
  ...
  <<post2>>
  printf("[qmckl_set_jastrow_type_nucl_num] Out\n");
}
                                          ...
                                          int device_id)
{
  ...
  printf("[qmckl_set_jastrow_type_nucl_vector_device] In\n");
  int32_t mask = 1 << 2;
...
#pragma omp target is_device_ptr(type_nucl_vector, new_array)
  ...
  <<post2_device>>
  printf("[qmckl_set_jastrow_type_nucl_vector_device] Out\n");
}
...
qmckl_set_jastrow_aord_vector_device(qmckl_context context,
                                     ...
                                     int device_id)
{
  printf("[qmckl_set_jastrow_aord_vector_device] In\n");
  int32_t mask = 1 << 3;
  ...
  if ((size_t) size_max < mem_info.size/sizeof(double)) {
	...
	printf("[qmckl_set_jastrow_aord_vector_device] 6\n");

  double* new_array = (double*) qmckl_malloc_device(context, mem_info, device_id);

	printf("[qmckl_set_jastrow_aord_vector_device] 7\n");
  ...
  if(new_array == NULL) {
	...
	printf("[qmckl_set_jastrow_aord_vector_device] 8\n");
  ...
  printf("[qmckl_set_jastrow_aord_vector_device] 9\n");

  <<post2_device>>
  printf("[qmckl_set_jastrow_aord_vector_device] Out\n");
}
...
qmckl_set_jastrow_bord_vector_device(qmckl_context context,
                                     ...
                                     int device_id)
{
  printf("[qmckl_set_jastrow_bord_vector_device] In\n");
  int32_t mask = 1 << 4;
  ...
  <<post2_device>>
  printf("[qmckl_set_jastrow_bord_vector_device] Out\n");
}
                                     ...
                                     int device_id)
{
  ...
  printf("[qmckl_set_jastrow_cord_vector_device] In\n");
  int32_t mask = 1 << 5;
  ...
  printf("[qmckl_set_jastrow_cord_vector_device] About to post2_device\n");
  <<post2_device>>
  printf("[qmckl_set_jastrow_cord_vector_device] Out\n");
}
#endif
   #+end_src
...
qmckl_exit_code qmckl_finalize_jastrow_device(qmckl_context context) {
  ...
  printf("[qmckl_finalize_jastrow_device] In\n");
  if (qmckl_context_check(context) == QMCKL_NULL_CONTEXT) {
    return QMCKL_INVALID_CONTEXT;
  }
  ...
  qmckl_context_struct* const ctx = (qmckl_context_struct*) context;
  assert (ctx != NULL);
  printf("[qmckl_finalize_jastrow_device] 1\n");
  ...
  printf("[qmckl_finalize_jastrow_device] 2\n");
  ...
  printf("[qmckl_finalize_jastrow_device] 3\n");

  printf("[qmckl_finalize_jastrow_device] Out\n");
  qmckl_exit_code rc = QMCKL_SUCCESS;
  return rc;
  ...
  for(int l=0; l<(cord_num+1); l++) {
    ...
    for(int a=0; nucl_num; a++) {
      for(int i=0; elec_num; i++) {
        ...
        een_rescaled_n_deriv_e[i + 1*rd_offset_1 + a*rd_offset_2 + l*rd_offset_3 + nw*rd_offset_4] = een_rescaled_n_deriv_e[i + 1*rd_offset_1 + a*rd_offset_2 + l*rd_offset_3 + nw*rd_offset_4] * een_rescaled_n[i + a*r_offset_1 + l*r_offset_2 + nw*r_offset_3];

        een_rescaled_n_deriv_e[i + 2*rd_offset_1 + a*rd_offset_2 + l*rd_offset_3 + nw*rd_offset_4] = een_rescaled_n_deriv_e[i + 2*rd_offset_1 + a*rd_offset_2 + l*rd_offset_3 + nw*rd_offset_4] * een_rescaled_n[i + a*r_offset_1 + l*r_offset_2 + nw*r_offset_3];
...
)
{
  ...
  // memcpy(factor_een_deriv_e, ctx->jastrow.factor_een_deriv_e, sze*sizeof(double));
  omp_target_memcpy(factor_een_deriv_e, ctx->jastrow.factor_een_deriv_e,
                    sze*sizeof(double),
                    0, 0,
                    device_id, device_id
                    );
