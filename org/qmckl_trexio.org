...
*** Nuclear charges
   ...
   #+begin_src c :tangle (eval c)
  {
    printf("  Entering nuclear charge\n");
    qmckl_memory_info_struct mem_info = qmckl_memory_info_struct_zero;
    mem_info.size = nucleus_num * sizeof(double);
...
*** Nuclear coordinates
   ...
   #+begin_src c :tangle (eval c)
  {
    printf("  Entering nuclear coords\n");
    qmckl_memory_info_struct mem_info = qmckl_memory_info_struct_zero;
    mem_info.size = nucleus_num * 3 * sizeof(double);
...
*** Nucleus_index array
   ...
   #+begin_src c :tangle (eval c)
  {
    printf("  Entering nucleus index array\n");
    qmckl_memory_info_struct mem_info = qmckl_memory_info_struct_zero;
    ...
    if (rc != QMCKL_SUCCESS)
      return rc;
    printf("  Leaving nucleus index array\n");
  }
   #+end_src
...
*** Number of shells per nucleus
   ...
   #+begin_src c :tangle (eval c)
  {
    printf("  Entering num shell per nucleus\n");
    qmckl_memory_info_struct mem_info = qmckl_memory_info_struct_zero;
    ...
    if (rc != QMCKL_SUCCESS)
      return rc;
    printf("  Leaving num shell per nucleus\n");
  }
   #+end_src
...
*** Angular momentum
   ...
   #+begin_src c :tangle (eval c)
  {
    printf("  Entering angular momentum\n");
    qmckl_memory_info_struct mem_info = qmckl_memory_info_struct_zero;
    ...
    if (rc != QMCKL_SUCCESS)
      return rc;
    printf("  Leaving angular momentum\n");
  }
   #+end_src
...
*** Number of primitives per shell
   ...
   #+begin_src c :tangle (eval c)
  {
    printf("  Entering num prim per shell\n");
    qmckl_memory_info_struct mem_info = qmckl_memory_info_struct_zero;
    ...
    if (rc != QMCKL_SUCCESS)
      return rc;
    printf("  Leaving num prim per shell\n");
  }
   #+end_src
...
*** Indices of the primitives
   ...
   #+begin_src c :tangle (eval c)
  {
    printf("  Entering indices of the primitives\n");
    qmckl_memory_info_struct mem_info = qmckl_memory_info_struct_zero;
    ...
    if (rc != QMCKL_SUCCESS)
      return rc;
    printf("  Leaving indices of the primitives\n");
  }
   #+end_src
...
*** Normalization of the shells
   ...
   #+begin_src c :tangle (eval c)
  {
    printf("  Entering normalization of shells\n");
    qmckl_memory_info_struct mem_info = qmckl_memory_info_struct_zero;
    ...
    if (rc != QMCKL_SUCCESS)
      return rc;
    printf("  Leaving normalization of shells\n");
  }
   #+end_src
...
*** Normalization of the primitivies
   ...
   #+begin_src c :tangle (eval c)
  {
    printf("  Entering normalization of prim\n");
    qmckl_memory_info_struct mem_info = qmckl_memory_info_struct_zero;
    ...
    if (rc != QMCKL_SUCCESS)
      return rc;
    printf("  Leaving normalization of prim\n");
  }
   #+end_src
...
*** AO Normalization
   #+begin_src c :tangle (eval c)
  {
    printf("  Entering normalization of AO\n");
    qmckl_memory_info_struct mem_info = qmckl_memory_info_struct_zero;
    ...
    printf("Done with func call\n");
    qmckl_free(context, ao_normalization);
    ao_normalization = NULL;

    if (rc != QMCKL_SUCCESS)
      return rc;
    printf("  Leaving normalization of AO\n");
  }
   #+end_src
...
*** MO coefficients
   ...
   #+begin_src c :tangle (eval c)
  {
    printf("  Entering MO coefficients\n");
    qmckl_memory_info_struct mem_info = qmckl_memory_info_struct_zero;
    mem_info.size = ao_num * mo_num * sizeof(double);
    ...
    printf("  Leaving MO coefficients\n");
  }
   #+end_src
...
{
  printf("qmckl_trexio_read_device\n");
  if (qmckl_context_check(context) == QMCKL_NULL_CONTEXT) {
    return false;
  }
