...
qmckl_exit_code
qmckl_trexio_read_nucleus_X_device(qmckl_context context, trexio_t* const file)
{
  assert (context != (qmckl_context) 0);
  assert (file != NULL);
...
*** Nuclear charges
   ...
   #+begin_src c :tangle (eval c)
    ...
    rc = qmckl_set_nucleus_charge_device(context, nucl_charge, nucleus_num);
...
*** Nuclear coordinates
   ...
   #+begin_src c :tangle (eval c)
  {
    ...
    rc = qmckl_set_nucleus_coord_device(context, 'N', nucl_coord, 3*nucleus_num);
...
#if defined(HAVE_TREXIO) && defined(HAVE_DEVICE_POINTERS)
qmckl_exit_code
qmckl_trexio_read_ao_X_device(qmckl_context context, trexio_t* const file)
{
  assert (context != (qmckl_context) 0);
  assert (file != NULL);
...
*** Nucleus_index array
   ...
   #+begin_src c :tangle (eval c)
  {
    ...
    if (tmp_array == NULL) {
      qmckl_free_device(context, nucleus_index, 0);
      nucleus_index = NULL;
      return qmckl_failwith( context,
                             QMCKL_ALLOCATION_FAILED,
                             "qmckl_trexio_read_basis_nucleus_index_X",
    ...
    /* Reformat data */
    rc = qmckl_set_ao_basis_nucleus_index_device(context, nucleus_index, nucleus_num);
    if (rc != QMCKL_SUCCESS) {
      qmckl_free(context, nucleus_index);
      nucleus_index = NULL;
      return rc;
    ...
    /* Store data */
    rc = qmckl_set_ao_basis_nucleus_index_device(context, nucleus_index, shell_num);
...
*** Number of shells per nucleus
   ...
   #+begin_src c :tangle (eval c)
  {
    ...
    /* Store data */
    rc = qmckl_set_ao_basis_nucleus_shell_num_device(context, nucleus_shell_num, shell_num);
...
*** Angular momentum
   ...
   #+begin_src c :tangle (eval c)
  {
    ...
    /* Store data */
    rc = qmckl_set_ao_basis_shell_ang_mom_device(context, shell_ang_mom, shell_num);
...
*** Number of primitives per shell
   ...
   #+begin_src c :tangle (eval c)
  {
    ...
    /* Store data */
    rc = qmckl_set_ao_basis_shell_prim_num_device(context, shell_prim_num, shell_num);
...
*** Indices of the primitives
   ...
   #+begin_src c :tangle (eval c)
  {
    ...
    /* Store data */
    rc = qmckl_set_ao_basis_shell_prim_index_device(context, shell_prim_index, shell_num);
...
*** Normalization of the shells
   ...
   #+begin_src c :tangle (eval c)
  {
    ...
    /* Store data */
    rc = qmckl_set_ao_basis_shell_factor_device(context, shell_factor, shell_num);
...
*** Coefficients
   ...
   #+begin_src c :tangle (eval c)
  {
    ...
    /* Store data */
    rc = qmckl_set_ao_basis_coefficient_device(context, coefficient, prim_num);
...
*** Normalization of the primitivies
   ...
   #+begin_src c :tangle (eval c)
  {
    ...
    /* Read data */
    rc = qmckl_set_ao_basis_prim_factor_device(context, prim_factor, prim_num);
...
*** AO Normalization
   #+begin_src c :tangle (eval c)
  {
    ...
    /* Store data */
    rc = qmckl_set_ao_basis_ao_factor_device(context, ao_normalization, ao_num);
...
#if defined(HAVE_TREXIO) && defined(HAVE_DEVICE_POINTERS)
qmckl_exit_code
qmckl_trexio_read_mo_X_device(qmckl_context context, trexio_t* const file)
{
  assert (context != (qmckl_context) 0);
  assert (file != NULL);
...
#ifdef HAVE_DEVICE_POINTERS
qmckl_exit_code
qmckl_trexio_read_device(const qmckl_context context, const char* file_name, const int64_t size_max)
{
  if (qmckl_context_check(context) == QMCKL_NULL_CONTEXT) {
    return false;
  }
