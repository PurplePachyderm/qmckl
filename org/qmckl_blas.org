                    ...
                    const int64_t size)
{
  ...
  qmckl_memory_info_struct mem_info = qmckl_memory_info_struct_zero;
  mem_info.size = size * sizeof(double);
  result.data = (double*) qmckl_malloc_device (context, mem_info, 0);
                   ...
                   qmckl_vector* vector)
{
  ...
  rc = qmckl_free(context, vector->data_device);
  if (rc != QMCKL_SUCCESS) {
    return rc;
  }
                   ...
                   qmckl_vector* vector)
{
  ...
  rc = qmckl_free_device(context, vector->data_device, 0);
  if (rc != QMCKL_SUCCESS) {
    return rc;
  }
                          ...
                          qmckl_matrix* matrix)
{
  ...
  rc = qmckl_free_device(context, matrix->data, 0);
  if (rc != QMCKL_SUCCESS) {
    return rc;
  }
  matrix->data = NULL;
